              ...
              bottomNavigationBar: BottomNavigationBar(
                ...
                items: [
                  ...
                  new BottomNavigationBarItem(
                    ...
                    title: Text('GstTax', style: TextStyle(color: Colors.white,),),
                    backgroundColor: Colors.grey[900],
                  ),
                  new BottomNavigationBarItem(
                    icon: Icon(Icons.mobile_screen_share,
                      color: Colors.lightGreenAccent.shade400,),
                    title: Text(
                      'Incometax', style: TextStyle(color: Colors.white,),),
                    backgroundColor: Colors.grey[900],
                  ),
                  new BottomNavigationBarItem(
                  ...
                  new BottomNavigationBarItem(
                    icon: Icon(Icons.shopping_cart,
                      color: Colors.lightGreenAccent.shade400,),
                    title: Text(
                      'News', style: TextStyle(color: Colors.white,),),
                    backgroundColor: Colors.grey[900],
                  ),
                ],
                onTap: (index) {
...
class GreenPay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Center(child: Text("Well come to Tax Calculator",style: TextStyle(fontSize: 40,color: Colors.grey[800]))),
    );
  }
}
...
class Cart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Center(child: Text("Please Select the items to calculate tax",style: TextStyle(fontSize: 40,color: Colors.grey[800]))),
    );
  }
}